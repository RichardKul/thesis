...
\begin{figure}[H]
 	...
 	\caption{Behavior of the membrane voltage for constant noise and changing bias current $I$}
 	\label{currentnoise} 
 \end{figure}
