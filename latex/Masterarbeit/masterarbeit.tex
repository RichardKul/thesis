...
In all of the cases, the spike train was cut into 50 segments, which corresponds to an ensemble of 50 neurons. The other relevant parameters are shown in table \ref{params}.
