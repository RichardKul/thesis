...
\begin{figure}[H]
	\subfigure[]{\includegraphics[scale=0.45]{inapreali20nbwnfont.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inapreali20wnfont.pdf}}\\	\subfigure[]{\includegraphics[scale=0.45]{inapreali20nbvfont.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inapreali20vfont.pdf}}
...
\begin{figure}[H]
	\subfigure[]{\includegraphics[scale=0.45]{inaprealanhopfnb.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inaprealanhopf.pdf}}\\	\subfigure[]{\includegraphics[scale=0.45]{inaprealanhopfnbvt.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inaprealanhopfvt.pdf}}
	...
	\label{subfigah} 
\end{figure}
Both regimes are separated by the unstable limit cycle. By crossing this ellipse from within or from the outside, the system goes over into the firing or resting state, respectively. The course of the unstable limit cycle can be seen in figure \ref{unstable}. These images were obtained by simulating the neuron model with negative time steps. That way, unstable regions are turned into stable ones and vice versa. 
\begin{figure}[H]
	\subfigure[]{\includegraphics[scale=0.45]{inaprealanhopfunstablewn2.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inaprealanhopfunstablevt.pdf}}
...
\begin{figure}[H]
	\subfigure[]{\includegraphics[scale=0.45]{inaprealanhopfnb2vt.pdf}} 
	\subfigure[]{	\includegraphics[scale=0.45]{inaprealanhopfunstable2.pdf}}
...
\begin{figure}[H]
	...
	\label{ahnoise} 
\end{figure}
Over a range of $1\mu A/cm^2$, the neuron switches from barely spiking to basically only spiking.
