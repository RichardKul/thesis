...
Interestingly, the resting neuron only seems to experiences changes in $V$, but not in $n$. This can be easily understood by taking another look at equation \ref{neq}. The variable directly influenced by noise is $V$. The changes are then carried on to $n$ via $n\infty(V)$. The equilibrium point is now so far on the left end of the n-nullcline, that even variations by tens of mV basically do not induce any change in $n\infty(V)$. Therefore, we only see fluctuations in the membrane voltage $V$ here. Of course the gating variable is still subject to perturbations, these just happen on a much smaller scale.
...
\begin{figure}[H]
	...
	\label{ppcompanhopf}
\end{figure}
Here, we see a quite stable limit cycle with amplitude variations of less than 5 mV, representing only a couple percent of the whole voltage range of the system. On the other hand, the resting state is much more irregular than as observed for the saddle-node bifurcation. The reason for this lies in the nature of the equilibrium point. When near the focus, the state vector does not directly approach it. Instead, it performs oscillations with shrinking radius. It is helpful to consider once more the eigenvalues of the Jacobian matrix. The ratio between real and imaginary part was about 1:46, meaning that the system near the equilibrium would roughly need to perform 10 oscillations to halve he radius of these oscillations. Therefore, the system only slowly approaches the resting point and can b easily influenced in either direction by noise.
...
In conclusion, both two-dimensional bursting neuron models display the same characteristics as the Brownian particle in a tilted potential. Therefore, we expect to find similar count statistics and Giant Diffusion for these systems as well. If this assumption is actually valid will be examined in the following chapter.
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{\includegraphics[scale=0.5]{dneursinglerealrinzel20ninv0realrinzel15ninv0.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{gneursinglerealrinzel20ninv0realrinzel15ninv0.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{eqdistplotmaster2.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{bdistplotmaster3.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{arrheniustotbigrealfast9acoarsetfrealfast23mtffit7fln.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{arrheniustotbigrealfast9acoarsetfrealfast23mtffit15fln.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnewbigrealfast23mtfrealfast19mtf.pdf}
		\label{nofit}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnewbigrealfast23mtfrealfast19mtf.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnewpred2realfast11jjem2shrealfast19jjem2st.pdf}
		\label{deffpred}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnewpred2realfast11jjem2shrealfast19jjem2st.pdf}
	\label{fanopred}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{eqdistajrj2realanhopf19flog354.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{bdistajrj2realanhopf19flog2013.pdf}}
	\caption{Distribution of equilibrium time intervals (left) and running time intervals at high switching rates}
	\label{intdistanhopf}
\end{figure}
\subsubsection{Transition rates at different noise intensities}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{arrheniustotbigrealanhopf19flogrealanhopf11flogfit3.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{arrheniustotbigrealanhopf19flogrealanhopf11flogfit11.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{barrieranhopfbig.pdf}
		\label{anhopfbarr}}
	\subfigure[]{	\includegraphics[scale=0.5]{barriercompanhopfcritbig.pdf}}
	\caption{Effective potential barriers for both transitions. As the running state is favored at high bias currents, $\Delta U_+$ increases, while the other one drops. The points where $\Delta U_i=2\Delta U_j$ correspond to the numerically computed intersection points from figure \ref{deff} with only slight deviations.}
\end{figure}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnew2shrealanhopf26flogrealanhopf19flog.pdf}
		\label{nofitanhopf}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnew2shrealanhopf26flogrealanhopf19flog.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnewpred2realanhopf19flogrealanhopf11flog.pdf}
		\label{deffpredanhopf}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnewpred2realanhopf19flogrealanhopf11flog.pdf}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{eqdistajrj2realrinzelrangeshort26d15009.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{bdistajrj2realrinzelrange26d12501.pdf}}
	\caption{Distribution of equilibrium time intervals (left) and running time intervals at high switching rates}
	\label{intdistrinzel}
\end{figure}
\subsubsection{Transition rates at different noise intensities}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{	\includegraphics[scale=0.5]{arrheniustotbigrealrinzelrange26d1realrinzelrange26d1fit0.pdf}}
	\subfigure[]{\includegraphics[scale=0.5]{arrheniustotbigrealrinzelrange26d1realrinzelrange26d1fit7.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{barrierinzelbig.pdf}
		\label{rinzelbarr}}
	\subfigure[]{	\includegraphics[scale=0.5]{barriercomprinzelcritbig.pdf}}
	\caption{Effective potential barriers for both transitions. As the running state is favored at high bias currents, $\Delta U_+$ increases, while the other one drops. The points where $\Delta U_i=2\Delta U_j$ correspond to the numerically computed intersection points from figure \ref{deff} with only slight deviations.}
\end{figure}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnew2bigrealrinzelrangelong26d1realrinzelrange26d1.pdf}
		\label{nofitrinzel}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnew2bigrealrinzelrangelong26d1realrinzelrange26d1.pdf}}
...
\begin{figure}[H]
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{dcompdfpwnewpred3realrinzelrange26d1realrinzelrange26d1.pdf}
		\label{deffpredrinzel}}
	\subfigure[]{	\includegraphics[scale=0.5]{fcompdfpwnewpred3realrinzelrange26d1realrinzelrange26d1.pdf}
...
\begin{figure}[H]
	...
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{specpaper6.pdf}}
	\subfigure[]{	\includegraphics[scale=0.5]{specpaper7.pdf}}
...
\begin{figure}[H]
	...
	\hspace*{-0.5cm}
	\subfigure[]{
		\includegraphics[scale=0.5]{specanhopf2.pdf}}
	\subfigure[]{	\includegraphics[scale=0.5]{specanhopf3.pdf}}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1]{snrinzelrange26dcompletecrit.pdf}\caption{Signal-to-noise ratio SNR for the Rinzel model with Saddle-node bifurcation}
	\label{specrinzel}
\end{figure}
