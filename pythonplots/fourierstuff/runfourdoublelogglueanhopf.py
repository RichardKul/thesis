...
#omega=np.arange(0,length)*2*np.pi/T
	...
	plt.suptitle('I=%.2f, D=%.2f' %(43+z*0.25,D*0.01))
...
#plt.xlim(4*10**(-4),100)
	...
	plt.arrow(0.277, 0.43, 0, -0.43, transform=plot1.transAxes, length_includes_head=True,head_width=0.01,head_length=0.03)
	plt.text(3*10**(-5),1,'signal')
	plt.text(3*10**(-5),0.4,'frequency')
	#plt.text(4*10**(-5),0.1,'signal')
	#plt.text(4*10**(-5),0.04,'frequency')
	#plt.arrow(70,10,0,-9,length_includes_head=True)
	plt.arrow(0.6857, 0.4, 0, -0.4, transform=plot1.transAxes, length_includes_head=True,head_width=0.01,head_length=0.03)
	#plt.arrow(0.6857, 0.3, 0, -0.3, transform=plot1.transAxes, length_includes_head=True,head_width=0.01,head_length=0.03)
	plt.text(2*10**2,0.2,'firing rate')
	plt.text(2*10**(2),0.09,'in spiking state')
	#plt.text(3*10**(-2),0.01,'firing rate')
	#plt.text(3*10**(-2),0.004,'in spiking state')
	#plt.text(8*10**(-7),2*d*timefac,'$2D_{eff}$')
	plt.text(8*10**(-7),1.2*d*timefac,'$2D_{eff}$')
