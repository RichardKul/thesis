...
t=np.arange(0.15,0.27,0.01)
xs=np.arange(0.16,0.26,0.02)
plt.yscale('log')
#plt.xscale('log')
...
plt.plot([0.163, 0.163], [2*10**(-3), 0.1], color='black', linestyle='-',label='$I_{crit}$')
#plt.plot([-0.02, -0.02], [2*10**(-3), 0.1], color='black', linestyle='-')
