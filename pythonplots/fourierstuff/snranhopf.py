...
for n in range(l2-1,l2):
	nl=round(ivalues-offset[n])
	plt.plot(xvec[n,0:nl],2*(SNR[n,0:nl]-1)/scale[n,0:nl],colorv[n]+'o',label='D=%.2f' %(Dtot[n]*0.1))
#for n in range(0,l2):
	#bv=b[2*n+1] # 3 plots
	#cv=c[2*n+1]
	#dv=d[2*n+1]
