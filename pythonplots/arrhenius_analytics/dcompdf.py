...
plt.plot(t,deffana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,2.5,v),'y')
plt.plot(t,deffana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,3,v),'g')
plt.plot(t,deffana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,4,v),'b')
plt.plot(t,deffana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,5,v),'r')
...
plt.plot(t,fanoana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,2.5,v),'y')
plt.plot(t,fanoana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,3,v),'g')
plt.plot(t,fanoana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,4,v),'b')
plt.plot(t,fanoana(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,5,v),'r')
#plt.plot(xsh,veco[0,:],label='D=1.2')
