...
#isteprate=0.01
#rate=np.zeros((dv,iv))
#file=open('/home/richard/outhome/firingratesreal.txt',"r")
#for k in file:
#	col=[]
#	row=k.split()
#	for j in range(0,dv):
...
#dr=np.zeros(dv,iv-2)
#DR=np.zeros(dv,ivalues)
#for dva in range(0,dv):
#	for iva in range(0,iv-2):
#		dr[dva][iva]=(rate[dva][iva+2]-rate[dva][iva])/(2*isteprate)
#
#for dva in range(0,dv):
#	for iva in range(0,ivalues):
#		DR[dva][iva]=dr[dva][2*iva]
