...
plt.plot(t,rate(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,2.5,vfunc(2.5)),'y')
plt.plot(t,rate(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,3,vfunc(3)),'g')
plt.plot(t,rate(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,4,vfunc(4)),'b')
plt.plot(t,rate(rbte,retb,params2[1],params2[3],params2[0],params2[2],t,5,vfunc(5)),'r')
...
plt.legend()
plt.savefig('gcompdf29mvarv.pdf')
