...
fil1=open('/home/richard/outhome/f1s.txt',"r")
x1,y1=[],[]
for k in fil1:
    row=k.split()
...
fil4=open('/home/richard/outhome/f2s.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome/f3s.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
...
fil6=open('/home/richard/outhome/f4s.txt',"r")
x6,y6=[],[]
for k in fil6:
    row=k.split()
