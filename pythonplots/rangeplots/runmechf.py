...
#fil1=open('/home/richard/outhome/Fano33al.txt',"r")
#x1,y1=[],[]
#for k in fil1:
#    row=k.split()
...
fil2=open('/home/richard/outhome/Fano43al.txt',"r")
x2,y2=[],[]
for k in fil2:
    row=k.split()
...
fil3=open('/home/richard/outhome/Fano56al.txt',"r")
x3,y3=[],[]
for k in fil3:
    row=k.split()
...
fil4=open('/home/richard/outhome/Fano72al.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome/Fano94al.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
