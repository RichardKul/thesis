...
fil1=open('/home/richard/outhome2/outhome/Deff33sh2.txt',"r")
x1,y1=[],[]
for k in fil1:
    row=k.split()
...
fil2=open('/home/richard/outhome2/outhome/Deff43sh2.txt',"r")
x2,y2=[],[]
for k in fil2:
    row=k.split()
...
fil3=open('/home/richard/outhome2/outhome/Deff56sh.txt',"r")
x3,y3=[],[]
for k in fil3:
    row=k.split()
...
fil4=open('/home/richard/outhome2/outhome/Deff72sh.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome2/outhome/Deff94sh.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
