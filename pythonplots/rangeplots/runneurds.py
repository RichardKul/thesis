...
fil1=open('/home/richard/outhome/d1s.txt',"r")
x1,y1=[],[]
for k in fil1:
    row=k.split()
...
fil4=open('/home/richard/outhome/d2s.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome/d3s.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
...
fil6=open('/home/richard/outhome/d4s.txt',"r")
x6,y6=[],[]
for k in fil6:
    row=k.split()
