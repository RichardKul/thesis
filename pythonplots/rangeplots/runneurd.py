...
fil1=open('/home/richard/outhome/d1mr.txt',"r")
x1,y1=[],[]
for k in fil1:
    row=k.split()
...
#fil2=open('/home/richard/outhome/d1.2mr.txt',"r")
#x2,y2=[],[]
#for k in fil2:
#    row=k.split()
...
#fil3=open('/home/richard/outhome/d1.5mr.txt',"r")
#x3,y3=[],[]
#for k in fil3:
#    row=k.split()
...
fil4=open('/home/richard/outhome/d2mr.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome/d3mr.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
...
fil6=open('/home/richard/outhome/d4mr.txt',"r")
x6,y6=[],[]
for k in fil6:
    row=k.split()
...
#fil7=open('/home/richard/outhome/d5mr.txt',"r")
#x7,y7=[],[]
#for k in fil7:
#    row=k.split()
...
#fil8=open('/home/richard/outhome/d6mr.txt',"r")
#x8,y8=[],[]
#for k in fil8:
#    row=k.split()
