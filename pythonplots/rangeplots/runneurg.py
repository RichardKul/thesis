...
fil1=open('/home/richard/outhome/g1mr.txt',"r")
x1,y1=[],[]
for k in fil1:
    row=k.split()
...
fil4=open('/home/richard/outhome/g2mr.txt',"r")
x4,y4=[],[]
for k in fil4:
    row=k.split()
...
fil5=open('/home/richard/outhome/g3mr.txt',"r")
x5,y5=[],[]
for k in fil5:
    row=k.split()
...
fil6=open('/home/richard/outhome/g4mr.txt',"r")
x6,y6=[],[]
for k in fil6:
    row=k.split()
